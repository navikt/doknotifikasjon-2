...
@Component
public class DoknotifikasjonMedKontaktInfoMapper {

	public NotifikasjonMedKontaktInfoTO map(NotifikasjonMedkontaktInfo doknotifikasjon) {
		return NotifikasjonMedKontaktInfoTO.builder()
				...
				.mobiltelefonnummer(doknotifikasjon.getMobiltelefonnummer())
				.epostadresse(doknotifikasjon.getEpostadresse())
