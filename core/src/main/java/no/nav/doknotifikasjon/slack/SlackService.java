package no.nav.doknotifikasjon.slack;
...
import no.nav.doknotifikasjon.config.properties.DoknotifikasjonProperties.SlackProperties;
...
public class SlackService {
	...
	SlackService(DoknotifikasjonProperties doknotifikasjonProperties) {
		slackProperties = doknotifikasjonProperties.getSlack();
