...
public class KafkaTopics {
	...
	public static final String KAFKA_TOPIC_DOK_NOTIFKASJON_STATUS = "privat-dok-notifikasjon-status";
	...
	public static final String KAFKA_TOPIC_DOK_NOTIFIKASJON_STOPP = "privat-dok-notifikasjon-stopp";
