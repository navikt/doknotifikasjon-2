...
@Profile("altinn2")
@Service
public class Altinn2VarselConsumer implements AltinnVarselConsumer {
	...
	public Altinn2VarselConsumer(@Value(SEND_TIL_ALTINN) Boolean sendTilAltinn, INotificationAgencyExternalBasic iNotificationAgencyExternalBasic, AltinnProps altinnProps) {
