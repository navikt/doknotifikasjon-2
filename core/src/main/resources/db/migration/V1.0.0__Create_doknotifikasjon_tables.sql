...
(
    NOTIFIKASJON_ID             NUMBER NOT NULL,
    ...
    K_STATUS                    VARCHAR(20) NOT NULL,            --Kodeverk
    ANTALL_RENOTIFIKASJONER     NUMBER,
    RENOTIFIKASJON_INTERVALL    NUMBER,                          --Number?
    NESTE_RENOTIFIKASJON_DATO   DATE,                            --Riktig?
    PREFERERTE_KANALER          VARCHAR(20),
    OPPRETTET_AV                VARCHAR(40) NOT NULL,
    OPPRETTET_DATO              TIMESTAMP NOT NULL,              --Timestamp(6)
...
CREATE SEQUENCE NOTIFIKASJON_ID_SEQ;

CREATE INDEX IDX_StatusAntallRenotifikasjonerNesteRenotifikasjonDato ON T_NOTIFIKASJON(K_STATUS, ANTALL_RENOTIFIKASJONER, NESTE_RENOTIFIKASJON_DATO);
...
(
    ...
    FOREIGN KEY (NOTIFIKASJON_ID) REFERENCES T_NOTIFIKASJON(NOTIFIKASJON_ID)
);
